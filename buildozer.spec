...
# (str) Package name
package.name = finance_tracker

# (str) Package domain (needed for android/ios packaging)
package.domain = org.lamayu
...
requirements = python3,kivy,plyer,httpx,httpcore,certifi,rfc3986,sniffio,anyio,h11,idna,sdl2_ttf==2.20.1
